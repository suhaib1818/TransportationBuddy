...
public class GoodsVehicle_Booking {
	...
	public String toString() {
		return "GoodsVehicle_Booking [username=" + username + ", source=" + source + ", destination=" + destination
				+ ", time=" + time + ", status=" + status + ", registrationno=" + registrationno + ", date=" + date
				+ ", request_date=" + request_date + ", booking_date=" + booking_date + "]";
	}

	public GoodsVehicle_Booking(String username, String source, String destination, String time, String status,
