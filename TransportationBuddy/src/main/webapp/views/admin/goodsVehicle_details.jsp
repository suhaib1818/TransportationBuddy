		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="login-form">
					<h3 class="text-center mb-4">Goods Vehicle Details</h3>
					<form id="login-form" class="row g-3" method="post"
						action="goodsvehicle">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" name="capacity"
								placeholder="Enter capacity (in Kilogram)" required>
							<div class="error"></div>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<label for="inputState" class="form-label">Help</label> <br>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="help"
									value="yes"> <label class="form-check-label">Yes</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="help"
...
<body>
	...
	<%@include file="/views/admin/admin_navbar.html"%>
	<h3 style="text-align: center; margin-top: 20px">Goods Vehicle
		Form</h3>
	<div class="container"
		...
		<form class="row g-3" method="post" action="goodsvehicle">
			<div class="col-md-6">
				<label class="form-label">Model Name</label> <input type="text"
					class="form-control" name="modelname">
			</div>
			<div class="col-md-6">
				<label class="form-label">Capacity (in Kilogram)</label> <input
					type="number" class="form-control" name="capacity">
			</div>
			<div class="col-md-2">
				<label class="form-label">Size (Length)</label> <input type="number"
					class="form-control" name="size">
			</div>
			<div class="col-md-2">
				<label class="form-label">Width</label> <input type="number"
					class="form-control" name="size">
			</div>
			<div class="col-md-2">
				<label class="form-label">Height</label> <input type="number"
					class="form-control" name="size">
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="help" value="no">
