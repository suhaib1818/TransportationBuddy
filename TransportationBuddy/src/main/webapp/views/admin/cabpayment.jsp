			...
			<div class="col-lg-12 col-xl-7">
				<div class="card">
					<div class="card-body p-5">
						<h2>Hi,</h2>
						<p class="fs-sm">
							Please check the payment of <strong>&#8377 ${totalFair}</strong>
							from the driver.
						</p>
						<div class="border-top border-gray-200 pt-4 mt-4">
							<div class="row">
								<div class="col-md-6">
									<div class="text-muted mb-2">Bill No.</div>
									<strong>#88305</strong>
								</div>
								<div class="col-md-6 text-md-end">
									<div class="text-muted mb-2">Bill Date</div>
									<strong>1/5/23</strong>
								</div>
							</div>
						</div>
						...
						<div class="border-top border-gray-200 py-4 mt-5">
							...
							<div class="d-flex justify-content-end mt-3">
								...
								<h5 class="text-success">&#8377 ${totalFair}</h5>
							</div>
						</div>
					</div>
				</div>
