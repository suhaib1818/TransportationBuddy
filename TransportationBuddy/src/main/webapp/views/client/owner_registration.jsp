			...
			<div class="card mt-5 col-md-6 animated bounceInDown myForm">
				<div class="card-header">
					<p class="animate-charcter"
						...
						<b><i class='fas fa-user-cog'></i> Contact Us Form</b>
					</p>
				</div>
				<div class="card-body">
					<form action="/owner/owner_registration" method="post"
						...
						<div id="dynamic_container">
							...
							<div class="input-group mt-3">
								...
								<div class="input-group mt-3">
									...
									<div class="invalid-feedback">Enter Your password Please
									</div>
									...
									<div class="input-group mt-3">
										...
										<input type="tel" name="phone" placeholder="Enter Your Name"
											class="form-control" required />
									...
									Lat : <input type="text" id="lat" name="latitude"> Lon
